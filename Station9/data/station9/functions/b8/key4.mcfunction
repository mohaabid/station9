setblock 49 52 20 minecraft:stone_button[face=wall,facing=west,powered=false]
...
playsound station9:sfx.beep_key block @a 49 52 20 1 1 0
scoreboard players operation #code s9 *= #10 s9
scoreboard players add #code s9 4
